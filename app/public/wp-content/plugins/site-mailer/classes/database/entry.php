...
namespace SiteMailer\Classes\Database;
...
class Entry {
	 ...
	 * Raises the hook [site-mailer/db/class_name>/change]. If the /event/
	 * parameter is not null, then it also raises the hook [site-mailer/db/class_name/event].
	 *
