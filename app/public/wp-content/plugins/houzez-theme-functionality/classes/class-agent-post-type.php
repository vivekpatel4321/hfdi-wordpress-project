...
class Houzez_Post_Type_Agent {
    ...
    public static function save_agent_meta($post_id, $post, $update) {
        ...
        $fave_agent_service_area = wp_kses($_POST['fave_agent_service_area'], $allowed_html);
        $fave_agent_specialties = wp_kses($_POST['fave_agent_specialties'], $allowed_html);
        ...
        update_user_meta( $user_id, 'fave_author_service_areas', $fave_agent_service_area);
        update_user_meta( $user_id, 'fave_author_specialties', $fave_agent_specialties);
