...
if( !function_exists('houzez_prop_carousel_v7') ) {
	function houzez_prop_carousel_v7($atts, $content = null)
	{
		...
		<div class="property-carousel-module houzez-carousel-arrows-<?php echo esc_attr($token); ?> property-carousel-module-v7 houzez-carousel-cols-<?php echo esc_attr($slides_to_show); ?> grid-view-<?php echo esc_attr($slides_to_show); ?>-cols">
				...
				<div id="houzez-properties-carousel-<?php echo esc_attr($token); ?>" data-token="<?php echo esc_attr($token); ?>" class="houzez-properties-carousel-js houzez-all-slider-wrap card-deck">
					...
					if ($the_query->have_posts()) : 
						while ($the_query->have_posts()) : $the_query->the_post();
							get_template_part('template-parts/listing/item', 'v7');
						endwhile; 
					endif;
					wp_reset_postdata();
					?>
	...
	add_shortcode('houzez-prop-carousel-v7', 'houzez_prop_carousel_v7');
}
?>