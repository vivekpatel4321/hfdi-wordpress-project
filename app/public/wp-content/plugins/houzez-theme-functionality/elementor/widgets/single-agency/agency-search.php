...
class Houzez_Agency_Search extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-agency-search';
	}

	public function get_title() {
		return __( 'Agency Search', 'houzez-theme-functionality' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'section_content',
            [
                'label' => __( 'Agency Search', 'houzez-theme-functionality' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'agency_search_border',
                'selector' => '{{WRAPPER}} .agent-ele-search-wrap',
            ]
        );

        $this->add_responsive_control(
            'agency_search_radius',
            [
	...
	protected function render() {
        ...
        htf_get_template_part('elementor/template-part/single-agency/agency-search');
...
Plugin::instance()->widgets_manager->register( new Houzez_Agency_Search );