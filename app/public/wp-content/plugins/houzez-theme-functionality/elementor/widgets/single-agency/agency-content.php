...
class Houzez_Agency_Content extends Widget_Base {
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-agency-content';
	}

	public function get_title() {
		return __( 'Agency Content', 'houzez-theme-functionality' );
	}

	public function get_icon() {
		return 'houzez-element-icon houzez-agency eicon-post-content';
	}
	...
	protected function render() {
        ...
        echo '<div class=hzel-agency-content>';
...
Plugin::instance()->widgets_manager->register( new Houzez_Agency_Content );