...
class Houzez_Agency_Listings_Reviews extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
    use Houzez_Filters_Traits;
    use Houzez_Property_Cards_Traits;

	public function get_name() {
		return 'houzez-agency-listings-reviews-tabs';
	}

	public function get_title() {
		return __( 'Agency Listings & Reviews Tabs', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return ['agency', 'listings', 'reviews', 'houzez' ];
	}
	...
	protected function render() {
        ...
        htf_get_template_part('elementor/template-part/single-agency/agency-listings-review');
...
Plugin::instance()->widgets_manager->register( new Houzez_Agency_Listings_Reviews );