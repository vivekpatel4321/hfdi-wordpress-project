...
class Houzez_Agency_Contact_Button extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Button_Traits;

	public function get_name() {
		return 'houzez-agency-email-btn';
	}

	public function get_title() {
		return __( 'Agency Contact Button', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return [ 'houzez', 'agency contact', 'popup', 'button' ];
	}
...
Plugin::instance()->widgets_manager->register( new Houzez_Agency_Contact_Button );