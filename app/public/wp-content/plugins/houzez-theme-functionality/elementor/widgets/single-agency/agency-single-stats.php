...
class Houzez_Agency_Single_Stat extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-agency-single-stat';
	}

	public function get_title() {
		return __( 'Agency Taxonomy Stats', 'houzez-theme-functionality' );
	}
	...
	protected function render() {
        ...
        htf_get_template_part('elementor/template-part/single-agency/agency-single-stats');
...
Plugin::instance()->widgets_manager->register( new Houzez_Agency_Single_Stat );