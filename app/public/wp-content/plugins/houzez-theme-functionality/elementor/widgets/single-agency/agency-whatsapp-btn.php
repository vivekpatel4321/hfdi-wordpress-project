...
class Houzez_Agency_WhatsApp_Button extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Button_Traits;

	public function get_name() {
		return 'houzez-agency-whatsapp-btn';
	}

	public function get_title() {
		return __( 'Agency WhatsApp Button', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return [ 'houzez', 'agency whatsapp', 'button' ];
	}
	...
	protected function render() {
        ...
        <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
            ...
            <a <?php $this->print_render_attribute_string( 'button' ); ?> target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr( $agency_whatsapp_call ); ?>">
	...
	<?php
        } // ! empty($agency_whatsapp)
        $this->reset_preview_query();
	}

}
Plugin::instance()->widgets_manager->register( new Houzez_Agency_WhatsApp_Button );