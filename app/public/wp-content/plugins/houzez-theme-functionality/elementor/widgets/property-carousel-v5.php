...
/**
 * Elementor Properties Carousel v5 Widget.
 * @since 2.0
 */
class Houzez_Elementor_Properties_Carousels_v5 extends Widget_Base {
    ...
    public function get_name() {
        return 'houzez_elementor_properties_carousel_v5';
    }
    ...
    public function get_title() {
        return esc_html__( 'Property Cards Carousel v5', 'houzez-theme-functionality' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'houzez_prop_carousel_v5' ) ) {
            echo houzez_prop_carousel_v5( $args );
        }
...
Plugin::instance()->widgets_manager->register( new Houzez_Elementor_Properties_Carousels_v5 );