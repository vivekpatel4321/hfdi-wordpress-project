...
class Houzez_Agent_Line_Button extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Button_Traits;

	public function get_name() {
		return 'houzez-agent-line-btn';
	}

	public function get_title() {
		return __( 'Agent LINE Button', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return [ 'houzez', 'agent line', 'button' ];
	}
	...
	protected function render() {
        ...
        $line_id = get_post_meta( get_the_ID(), 'fave_agent_line_id', true );
...
Plugin::instance()->widgets_manager->register( new Houzez_Agent_Line_Button );