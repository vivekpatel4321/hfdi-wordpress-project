...
class Houzez_Agent_Contact_Button extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Button_Traits;

	public function get_name() {
		return 'houzez-agent-email-btn';
	}

	public function get_title() {
		return __( 'Agent Contact Button', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return [ 'houzez', 'agent contact', 'popup', 'button' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => esc_html__( 'Contact Button', 'houzez-theme-functionality' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'Send Email',
                'placeholder' => esc_html__( 'Add title', 'houzez-theme-functionality' ),
            ]
        );
	...
	protected function render() {
        ...
        <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
            <button <?php $this->print_render_attribute_string( 'button' ); ?> type="button" data-toggle="modal" data-target="#realtor-form">
...
Plugin::instance()->widgets_manager->register( new Houzez_Agent_Contact_Button );