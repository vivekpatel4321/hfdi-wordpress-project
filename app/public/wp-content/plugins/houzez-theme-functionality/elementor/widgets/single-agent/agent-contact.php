...
class Houzez_Agent_Contact extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-agent-contact';
	}

	public function get_title() {
		return __( 'Agent Contact', 'houzez-theme-functionality' );
	}
        ...
        <div class="agent-contacts-wrap">
            ...
            <div class="agent-map">
                ...
                if( $settings['show_address'] ) {
                    get_template_part('template-parts/realtors/agent/address'); 
                }?>
            </div>
            <?php } ?>
...
Plugin::instance()->widgets_manager->register( new Houzez_Agent_Contact );