...
class Houzez_Agent_WhatsApp_Button extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Button_Traits;

	public function get_name() {
		return 'houzez-agent-whatsapp-btn';
	}

	public function get_title() {
		return __( 'Agent WhatsApp Button', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return [ 'houzez', 'agent whatsapp', 'button' ];
	}
	...
	protected function render() {
        ...
        <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
            ...
            <a <?php $this->print_render_attribute_string( 'button' ); ?> target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr( $agent_whatsapp_call ); ?>">
...
Plugin::instance()->widgets_manager->register( new Houzez_Agent_WhatsApp_Button );