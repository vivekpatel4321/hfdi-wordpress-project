...
class Houzez_Agent_Stats extends Widget_Base {
    use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-agent-stats';
	}

	public function get_title() {
		return __( 'Section Agent Stats', 'houzez-theme-functionality' );
	}
	...
	protected function render() {
        ...
        htf_get_template_part('elementor/template-part/single-agent/agent-stats');
...
Plugin::instance()->widgets_manager->register( new Houzez_Agent_Stats );