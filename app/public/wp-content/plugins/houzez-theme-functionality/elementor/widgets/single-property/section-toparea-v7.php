                ...
                <div class="property-banner">
                                    ...
                                    <div id="houzez-photoswipe-gallery-mobile-<?php echo esc_attr($gallery_token); ?>" class="houzez-photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
                                        ...
                                        if(!empty($listing_images)) {
                                            ...
                                            foreach( $listing_images as $image ) {
                                                ...
                                                $width = isset($image['sizes']['houzez-gallery']['width']) ? $image['sizes']['houzez-gallery']['width'] : 1170;
                                                $height = isset($image['sizes']['houzez-gallery']['height']) ? $image['sizes']['houzez-gallery']['height'] : 785;
                                                ?>
                    ...
                    <div class="hidden-on-mobile">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div id="houzez-photoswipe-gallery-<?php echo esc_attr($gallery_token); ?>" class="houzez-photoswipe property-banner-grid-wrap">
