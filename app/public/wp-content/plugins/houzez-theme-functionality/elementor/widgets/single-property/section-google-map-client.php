...
class Property_Section_Map extends \Elementor\Widget_Base {
    ...
    public function __construct( array $data = [], array $args = null ) {
        ...
        wp_register_script( 'houzez-elementor-single-map-scripts', HOUZEZ_PLUGIN_URL . $js_path . 'property-single-google-map.js', array( 'jquery' ), '1.0.0' );
	...
	protected function render() {
        ...
        <div class="houzez-elementor-map-wrap">
            <div class="houzez-single-ele-map-js" data-mapId="houzez-single-map-<?php echo esc_attr($this->get_id());?>"
                 data-mapOptions = '<?php echo json_encode($map_options);?>'
                 data-propertyData = '<?php echo json_encode( $property_data );?>'
                 id="houzez-single-map-<?php echo $this->get_id(); ?>" class="h-properties-map-for-elementor"></div>
        </div>
