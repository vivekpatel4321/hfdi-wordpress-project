...
class Houzez_Post_Info extends Widget_Base {
	use \HouzezThemeFunctionality\Elementor\Traits\Houzez_Preview_Query;

	public function get_name() {
		return 'houzez-post-info';
	}

	public function get_title() {
		return __( 'Post Info', 'houzez-theme-functionality' );
	}

	public function get_icon() {
		return 'houzez-element-icon houzez-post eicon-post-info';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => esc_html__( 'Default', 'houzez-theme-functionality' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => esc_html__( 'Inline', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'time' => esc_html__( 'Time', 'houzez-theme-functionality' ),
					'comments' => esc_html__( 'Comments', 'houzez-theme-functionality' ),
					'terms' => esc_html__( 'Terms', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			'date_format',
			[
				'label' => esc_html__( 'Date Format', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
					'0' => _x( 'March 6, 2018 (F j, Y)', 'Date Format', 'houzez-theme-functionality' ),
					'1' => '2018-03-06 (Y-m-d)',
					'2' => '03/06/2018 (m/d/Y)',
					'3' => '06/03/2018 (d/m/Y)',
					'custom' => esc_html__( 'Custom', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			'custom_date_format',
			[
				'label' => esc_html__( 'Custom Date Format', 'houzez-theme-functionality' ),
				...
				'description' => sprintf(
					...
					__( 'Use the letters: %s', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			'time_format',
			[
				'label' => esc_html__( 'Time Format', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
		...
		$repeater->add_control(
			'custom_time_format',
			[
				'label' => esc_html__( 'Custom Time Format', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'g:i a',
				'placeholder' => 'g:i a',
				'condition' => [
		...
		$repeater->add_control(
			'show_avatar',
			[
				'label' => esc_html__( 'Avatar', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Custom Format', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => false,
				'condition' => [
					'type' => 'comments',
		...
		$repeater->add_control(
			'string_no_comments',
			[
				'label' => esc_html__( 'No Comments', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'No Comments', 'houzez-theme-functionality' ),
				'condition' => [
		...
		$repeater->add_control(
			'string_one_comment',
			[
				'label' => esc_html__( 'One Comment', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'One Comment', 'houzez-theme-functionality' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '%s Comments', 'houzez-theme-functionality' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'custom_text',
			[
				'label' => esc_html__( 'Custom', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'custom_url',
			[
				'label' => esc_html__( 'Custom URL', 'houzez-theme-functionality' ),
		...
		$repeater->add_control(
			'selected_icon',
			[
				'label' => esc_html__( 'Choose Icon', 'houzez-theme-functionality' ),
		...
		$this->add_control(
			'text_indent',
			[
				'label' => esc_html__( 'Indent', 'houzez-theme-functionality' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
	...
	protected function get_taxonomies() {
		...
		$options = [
			'' => esc_html__( 'Choose', 'houzez-theme-functionality' ),
		];
	...
	protected function get_meta_data( $repeater_item ) {
		...
		switch ( $repeater_item['type'] ) {
			...
			case 'comments':
				if ( comments_open() ) {
					$default_strings = [
						'string_no_comments' => esc_html__( 'No Comments', 'houzez-theme-functionality' ),
						'string_one_comment' => esc_html__( 'One Comment', 'houzez-theme-functionality' ),
						'string_comments' => esc_html__( '%s Comments', 'houzez-theme-functionality' ),
					];
					...
					if ( 0 === $num_comments ) {
						...
						$item_data['text'] = sprintf( _n( $default_strings['string_one_comment'], $default_strings['string_comments'], $num_comments, 'houzez-theme-functionality' ), $num_comments );
					}
	...
	protected function houzez_render_item( $repeater_item ) {
		...
		<li <?php $this->print_render_attribute_string( $item_key ); ?>>
			...
			<a <?php $this->print_render_attribute_string( $link_key ); ?>>
				<?php endif; ?>
				<?php $this->houzez_render_item_icon_or_image( $item_data, $repeater_item, $repeater_index ); ?>
				<?php $this->houzez_render_item_text( $item_data, $repeater_index ); ?>
				<?php if ( $has_link ) : ?>
			</a>
		<?php endif; ?>
		</li>
	...
	protected function houzez_render_item_icon_or_image( $item_data, $repeater_item, $repeater_index ) {
	...
	protected function houzez_render_item_text( $item_data, $repeater_index ) {
		$repeater_setting_key = $this->get_repeater_setting_key( 'text', 'icon_list', $repeater_index );

		$this->add_render_attribute( $repeater_setting_key, 'class', [ 'elementor-icon-list-text', 'houzez-post-info__item', 'houzez-post-info__item--type-' . $item_data['type'] ] );
		...
		<span <?php $this->print_render_attribute_string( $repeater_setting_key ); ?>>
			<?php if ( ! empty( $item_data['text_prefix'] ) ) : ?>
				<span class="houzez-post-info__item-prefix"><?php echo esc_html( $item_data['text_prefix'] ); ?></span>
			<?php endif; ?>
			<?php
			if ( ! empty( $item_data['terms_list'] ) ) :
				$terms_list = [];
				$item_class = 'houzez-post-info__terms-list-item';
				?>
				<span class="houzez-post-info__terms-list">
				<?php
	...
	protected function render() {
		...
		if ( ! empty( $settings['icon_list'] ) ) {
			foreach ( $settings['icon_list'] as $repeater_item ) {
				$this->houzez_render_item( $repeater_item );
			}
		}
		...
		$this->add_render_attribute( 'icon_list', 'class', [ 'houzez-post-info', 'elementor-icon-list-items' ] );
...
Plugin::instance()->widgets_manager->register( new Houzez_Post_Info );