<div class="dashboard-slide-panel-wrap enquiry-panel-js">
	...
	<div class="lined-block">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Property Status', 'houzez'); ?></label>
					<select id="property_status" name="e_meta[property_status]" class="selectpicker form-control bs-select-hidden" title="<?php esc_html_e('Select', 'houzez'); ?>" data-live-search="true">
						<?php
                        // All Option
                        echo '<option value="">'.esc_html__('Select', 'houzez').'</option>';
			...
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Property Label', 'houzez'); ?></label>
					<select id="property_label" name="e_meta[property_label]" class="selectpicker form-control bs-select-hidden" title="<?php esc_html_e('Select', 'houzez'); ?>" data-live-search="true">
						<?php
                        // All Option
                        echo '<option value="">'.esc_html__('Select', 'houzez').'</option>';
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					...
					<input class="form-control" name="e_meta[streat_address]" id="streat_address" placeholder="<?php esc_html_e('Enter the streat address', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-12 col-sm-12 -->
		</div>
	</div>
