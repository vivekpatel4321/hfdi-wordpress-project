...
<ul class="item-tools item-tools-v2">
    ...
    <li class="item-tool item-compare">
        <span class="houzez_compare compare-<?php echo intval($post->ID); ?> item-tool-compare show-compare-panel" data-toggle="tooltip" data-placement="top" title="<?php echo houzez_option('cl_add_compare', 'Add to Compare'); ?>" data-listing_id="<?php echo intval($post->ID); ?>" data-listing_image="<?php echo esc_attr($property_img_url); ?>">
