...
$stats = houzez_get_realtor_tax_stats('property_type', 'fave_property_agency', $properties_ids);
...
<div class="agent-profile-chart-wrap">
	<h2><?php echo houzez_option('agency_lb_property_types', wp_kses(__( '<span>Property</span> Types', 'houzez' ), houzez_allowed_html() )); ?></h2>
