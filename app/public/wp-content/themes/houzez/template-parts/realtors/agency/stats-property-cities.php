...
$stats = houzez_get_realtor_tax_stats('property_city', 'fave_property_agency', $properties_ids);
...
<div class="agent-profile-chart-wrap">
	<h2><?php echo houzez_option('agency_lb_property_cities', wp_kses(__( '<span>Property</span> Cities', 'houzez' ), houzez_allowed_html() )); ?></h2>
