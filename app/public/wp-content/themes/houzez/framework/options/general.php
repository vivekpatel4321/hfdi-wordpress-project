...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            'id'       => 'houzez_site_width',
            'type'     => 'button_set',
            'title'    => esc_html__('Site Container Width', 'houzez'),
            'subtitle' => esc_html__('Select website container width.', 'houzez'),
            'options' => array(
                '1210px' => '1170px',
                '1310px' => '1270px',
                '1410px' => '1370px',
        ...
        array(
            'id'       => 'dsh_home_btn',
            'type'     => 'switch',
            'title'    => esc_html__( 'Home Link', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show home link in front-end dashboard?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            'id'       => 'halfmap-footer',
            'type'     => 'switch',
            'title'    => esc_html__( 'Half Map Footer', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show footer for half map template & half map search page?', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            'id'       => 'add_to_favorite',
            'type'     => 'switch',
            'title'    => esc_html__( 'Add to favorites', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Login required for add to favorites?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        ...
        array(
            ...
            'desc'     => '',
            'subtitle' => esc_html__( 'Show image caption for property detail page gallery?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        array(
            ...
            'desc'     => '',
            'subtitle' => esc_html__( 'Show image caption for popup gallery?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        ...
        array(
            ...
            'subtitle' => esc_html__('Select which taxonomy filters you want to disable.', 'houzez'),
            'options' => array(
